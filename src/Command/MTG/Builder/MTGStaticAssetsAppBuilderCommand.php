...
#[AsCommand(
    name: 'aeonshift:mtg:builder:staticassets',
    description: 'Build the static MTG application assets',
    aliases: ['as:mtg:b:sa']
)]
final class MTGStaticAssetsAppBuilderCommand extends Command
{
