...
namespace App\Model\MTG\Source\Download\Scryfall\V1;
...
final class MTGScryfallDefaultCardsSourceDownloadModelV1
{
    ...
    private const string CHANNEL = 'scryfall/defaultmtgcards/download/v' . self::VERSION;
     ...
     * @throws DateMalformedStringException|JsonException|TransportExceptionInterface
     *
    ...
    public function downloadDefaultCards(array $defaultCardsEntry, ?callable $progressCallback = null, string $startedFrom = 'cli'): string
    {
        ...
        try {
            ...
            try {
                ...
                $this->sourceActivityHistory->setSuccessSummary(
                    json_encode([
                ...
                if ($this->entityManager->isOpen()) {
                    // Finalize source activity history in both logs and DB
                    $this->sourceActivityHistory->setEndedAt(new DateTime());
                    $this->sourceActivityHistory->setErrorSummary($e->getMessage());
                    $this->entityManager->persist($this->sourceActivityHistory);
                    $this->entityManager->flush();
                }
     ...
     * @throws DateMalformedStringException|DecodingExceptionInterface|JsonException
     *
